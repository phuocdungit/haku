    ...
    if ( ! class_exists( 'ReduxDebugObject' ) ) {
        ...
        class ReduxDebugObject {
            ...
            public function render() {
                ...
                echo '<h3>' . esc_html__( 'Options Object', 'sage' ) . '</h3>';
                ...
                echo '<a href="#" id="consolePrintObject" class="button">' . esc_html__( 'Show Object in Javascript Console Object', 'sage' ) . '</a>';
            ...
            public function render_tab() {
                ...
                echo '<a href="javascript:void(0);" id="dev_mode_default_section_group_li_a" class="redux-group-tab-link-a custom-tab" data-rel="dev_mode_default">' . $icon . ' <span class="group_title">' . esc_html__( 'Options Object', 'sage' ) . '</span></a>';
                echo '</li>';
            }
            ...
            public function add_submenu() {
                add_submenu_page(
                    ...
                    esc_html__( 'Options Object', 'sage' ),
                    esc_html__( 'Options Object', 'sage' ),
